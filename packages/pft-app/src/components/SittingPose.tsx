            ...
            <svg viewBox="0 0 1647 2500" version="1.1" xmlns="http://www.w3.org/2000/svg">
                ...
                <g id="a-mono/sitting" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    <g id="pose" transform="translate(-81.000000, 637.000000)">
                        <Dynamic component={PoseSittingComponents[store.state.pose as PoseSittingKeys]} style="overflow: visible" />
                    </g>
                    <g id="Head" transform="translate(345.000000, 180.000000)">
                        <g id="head">
                            <Dynamic component={HeadComponents[store.state.head]} style="overflow: visible" />
                        </g>
                        <g id="face" transform="translate(159.000000, 186.000000)" fill="#000000">
                            <Dynamic component={FaceComponents[store.state.face]} style="overflow: visible" />
                        </g>
                        <g id="facial-hair" transform="translate(123.000000, 338.000000)">
                            <Dynamic component={FacialHairComponents[store.state.facialHair]} style="overflow: visible" />
                        </g>
                        <g id="accessories" transform="translate(47.000000, 241.000000)">
                            <Dynamic component={AccessoriesComponents[store.state.accessories]} style="overflow: visible" />
                        </g>
                    </g>
                </g>
            </svg>)
